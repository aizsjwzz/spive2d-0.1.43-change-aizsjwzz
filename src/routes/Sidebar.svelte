<script>
	...
	let { onDirChange, onSceneChange, onAnimationChange, onExpressionChange, onSettingsClick ,onFileSortModeChange} = $props();
...
<div id="sidebar" class:hidden={!sidebarVisible}>
  ...
  />
	...
	{#if appState.mergeSequential}
	<div id="fileSortModeContainer">
		<span>{t('paixu')}</span>
		<select id="fileSortMode" bind:value={appState.fileSortMode} onchange={() =>{ console.log('[SORT DEBUG] Sidebar change:', appState.fileSortMode); onFileSortModeChange(); }}>
